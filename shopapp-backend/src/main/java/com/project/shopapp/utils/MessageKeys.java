...
public class MessageKeys {
    ...
    public static final String CREATE_COUPON_SUCCESSFULLY = "coupon.create.success";
    public static final String CONDITION_COUPON = "coupon.condition.required";
    public static final String  MISSING_DISCOUNT_AMOUNT_COUPON = "coupon.discountAmount.required";
